...
const TourUpdatePage: React.FC = () => {
  ...
  const fetchTourData = async () => {
    try {
      ...
      const formattedData = {
        ...
        tourDetailsRequests:
          data.tourResponse?.tourDetails.map((detail: any) => ({
            id: detail.id,
            day: detail.day,
        ...
        tourPriceRequests: data.tourResponse.tourPriceResponse || [],
        tourPaymentRequests: data.tourResponse.paymentPolicy || [],
        tourCancellationRequests: data.tourResponse.cancellationPolicy || [],
        tourPromotionRequests: data.tourResponse.promotionPolicy || [],
      };
  ...
  const onFinish = async (values: any) => {
    try {
      ...
      const formattedDepartureDate = values.departureDate.toISOString();
      ...
      console.log(values.tourPaymentRequests);
